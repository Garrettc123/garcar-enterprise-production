"""Revenue mission planner: converts business goals into executable channels.

This creates real execution plans; adapters perform actual external actions.
No revenue is claimed until an adapter reports a verified outcome.
"""
...
def build_missions(objective:str="maximize verified revenue") -> list[dict[str,Any]]:
    return [asdict(RevenueMission(c,objective,a,o,risk=r)) for c,_,a,o,r,risk in CHANNELS]
